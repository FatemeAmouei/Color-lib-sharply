    ...
    <div className='header-container'>
      <div className="section-navbar">
        <div className="section-navbar__left">
          <h2 className="logo"><a href='#'>Shapely Demo</a></h2>
        </div>
        <div className="section-navbar__right">
          <ul className="navbar-list">
          <li className='navbar-list-li'><a href='Home' class='navbar-list-link'>HOME</a></li>
          <li className='navbar-list-li'> <a href='BLOG' class='navbar-list-link'>BLOG</a></li>
          <li className='navbar-list-li'> <a href='PORTFOLIO' class='navbar-list-link'>PORTFOLIO</a></li>
